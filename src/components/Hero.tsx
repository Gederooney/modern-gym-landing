      ...
      <div className="max-w-[120rem] mx-auto h-full relative z-[2] px-6 md:px-8 lg:px-10">
        <div className="h-full w-full  flex flex-col relative space-y-6">
          <div className="mt-auto mb-0 text-gray-50 md:pb-36 space-y-6">
            <span className="font-light text-sm text-accent-500 ">Bienvenu a fitihealth</span>
            ...
            <div className="md:flex-row flex-col flex gap-4">
              <button className="inline-block text-base font-medium px-12 py-2 bg-accent-400 rounded-lg cursor-pointer max-w-96 md:max-w-none">
                En savoir plus
              </button>
              <button className="inline-block text-base font-medium px-12 py-2 border border-accent-400 rounded-lg text-accent-400 cursor-pointer bg-gray-50/10 backdrop-blur-3xl max-w-96 md:max-w-none">
                Nos Horaires
              </button>
            </div>
          </div>
            ...
            <ul className="flex md:flex-col items-center justify-center gap-2">
              ...
              <li className="h-6 w-6 block rounded-full bg-accent-400 text-gray-50">
                <a href="" className="h-full w-full block p-1">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-full h-full fill-current " viewBox="0 0 512 512">
                    <path
                    ...
                    <path
                      ...
                      fill="currentColor"
                    />
                    <ellipse cx="208" cy="152" rx="16" ry="24" fill="currentColor" />
                    <ellipse cx="304" cy="152" rx="16" ry="24" fill="currentColor" />
                  </svg>
                </a>
              </li>
              <li className="h-6 w-6 block rounded-full bg-accent-400 text-gray-50 p-1">
                ...
                >
                  ...
                  <path fill="none" d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" />
                  <line fill="none" x1="17.5" y1="6.5" x2="17.51" y2="6.5" />
                </svg>
              </li>
            </ul>
          </div>
